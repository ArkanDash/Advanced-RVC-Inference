...
def get_version() -> str:
    ...
    try:
        from arvc._version import __version__
        return __version__
    except ImportError:
        return "2.1.0"
...
def list_f0_methods():
    ...
    from arvc.utils.variables import method_f0_full
    ...
    from arvc.utils.variables import hybrid_f0_method
...
def cmd_uvr(args):
    ...
    try:
        ...
        from arvc.utils.variables import python, configs
...
def cmd_serve(args):
    ...
    try:
        from arvc.app.gui import launch
...
For the full CLI guide, see:
  https://github.com/ArkanDash/Advanced-RVC-Inference/blob/master/docs/README.md
    ...
    p.add_argument("--vocoder", default="Default", help="Vocoder (default: Default). Choices: Default, MRF-HiFi-GAN, RefineGAN, BigVGAN")
