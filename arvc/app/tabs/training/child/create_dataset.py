...
def create_dataset_tab():
    ...
    with gr.Row():
        ...
        output_dataset = gr.Textbox(label=translations["output_data"], info=translations["output_data_info"], value="arvc/assets/dataset", placeholder="dataset", interactive=True)
    with gr.Row():
