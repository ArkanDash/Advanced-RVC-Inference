...
from arvc.services.inference.presets import load_presets, save_presets
from arvc.rvc.inference.inference import convert_audio, convert_selection
from arvc.utils.variables import translations, paths_for_files, sample_rate_choice, model_name, index_path, method_f0, f0_file, embedders_mode, embedders_model, presets_file, configs, file_types, export_format_choices, hybrid_f0_method
from arvc.utils.feedback import visible, valueFalse_interactive, change_audios_choices, change_f0_choices, unlock_f0, change_preset_choices, change_backing_choices, hoplength_show, change_models_choices, get_index, index_strength_show, change_embedders_mode, shutil_move
        ...
        with gr.Column():
            ...
            with gr.Accordion(translations["input_output"], open=False):
                with gr.Column():
                    ...
                    output_audio = gr.Textbox(label=translations["output_path"], value="arvc/assets/audios/rvc/output.wav", placeholder="audios/output.wav", info=translations["output_path_info"], interactive=True)
                with gr.Column():
