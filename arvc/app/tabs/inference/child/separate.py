...
from arvc.downloader.downloads import download_url
    ...
    with gr.Row():
        ...
        with gr.Row():
            with gr.Accordion(translations["input_output"], open=False):
                ...
                output_dirs = gr.Textbox(label=translations["output_folder"], value=configs.get("uvr_path", "arvc/assets/audios/uvr"), placeholder="audios", info=translations["output_folder_info"], interactive=True)
