            ...
            with gr.Row():
                with gr.Accordion(label=translations["setting"], open=False):
                    ...
                    with gr.Group():
                        ...
                        vocoders = gr.Dropdown(label=translations["vocoder"], info=translations["vocoder_info"], choices=get_vocoder_choices(), value=get_vocoder_choices()[0], interactive=True, allow_custom_value=True) 
                    with gr.Row():
