...
from advanced_rvc_inference.services.downloads import download_url
from advanced_rvc_inference.services.separate import separate_music
from advanced_rvc_inference.ui.feedback import visible, valueFalse_interactive, change_audios_choices, shutil_move, separate_change
    ...
    with gr.Row():
        ...
        with gr.Row():
            with gr.Accordion(translations["input_output"], open=False):
                ...
                output_dirs = gr.Textbox(label=translations["output_folder"], value=configs.get("uvr_path", "advanced_rvc_inference/assets/audios/uvr"), placeholder="audios", info=translations["output_folder_info"], interactive=True)
