...
from advanced_rvc_inference.library.architectures.predictors.RMVPE.mel import MelSpectrogram
...
class RMVPE:
    def __init__(self, model_path, is_half, device=None, providers=None, onnx=False):
        ...
        if self.onnx:
            ...
            from advanced_rvc_inference.library.architectures.predictors.RMVPE.e2e import E2E
