...
logs_path = os.path.join("advanced_rvc_inference", "logs")
...
def run_tts_script(
    ...
    tts_script_path = os.path.join("advanced_rvc_inference", "rvc", "lib", "tools", "tts.py")

    assets_path = os.path.join("advanced_rvc_inference", "assets")
...
def run_preprocess_script(
    ...
    preprocess_script_path = os.path.join("advanced_rvc_inference", "rvc", "train", "preprocess", "preprocess.py")
    command = [
        python,
...
def run_extract_script(
    ...
    extract_script_path = os.path.join("advanced_rvc_inference", "rvc", "train", "extract", "extract.py")
...
def run_train_script(
    ...
    train_script_path = os.path.join("advanced_rvc_inference", "rvc", "train", "train.py")
    command = [
        python,
        train_script_path,
        *map(
...
def run_index_script(model_name: str, index_algorithm: str):
    index_script_path = os.path.join("advanced_rvc_inference", "rvc", "train", "process", "extract_index.py")
    command = [
        python,
        index_script_path,
        os.path.join(logs_path, model_name),
