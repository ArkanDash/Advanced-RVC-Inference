...
# Additional imports needed for UVR functionality
import shutil
import torch
...
def run_infer_script(
    ...
    # Map Vietnamese-RVC embedder names to Applio format
    embedder_mapping = {
        "contentvec_base": "contentvec",
        "hubert_base": "contentvec",  # Using contentvec as default since hubert isn't available in Applio
        "vietnamese_hubert_base": "contentvec",
        "japanese_hubert_base": "japanese-hubert-base",
        "korean_hubert_base": "korean-hubert-base",
        "chinese_hubert_base": "chinese-hubert-base",
        "portuguese_hubert_base": "contentvec",
        "custom": "custom"
    }

    # Map Vietnamese-RVC f0 methods to Applio format
    f0_mapping = {
        ...
        "mangio-penn": "harvest",
        "djcm": "harvest",
        "djcm-clipping": "harvest",
        "djcm-medfilt": "harvest",
        "djcm-clipping-medfilt": "harvest",
        "swift": "harvest",
        "pesto": "harvest",
        "pm-ac": "harvest",
        "pm-cc": "harvest",
        ...
        "pyin": "harvest",
        "swipe": "harvest",
        "hybrid[crepe+rmvpe]": "hybrid",
        "hybrid[crepe+fcpe]": "hybrid",
        "hybrid[rmvpe+fcpe]": "hybrid",
        "hybrid[crepe+rmvpe+fcpe]": "hybrid"
    }

    mapped_embedder_model = embedder_mapping.get(embedder_model, embedder_model)
    ...
    kwargs = {
        ...
        "embedder_model": mapped_embedder_model,
