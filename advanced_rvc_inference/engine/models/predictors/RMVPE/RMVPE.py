...
from advanced_rvc_inference.engine.models.predictors.RMVPE.mel import MelSpectrogram
...
class RMVPE:
    def __init__(self, model_path, is_half, device=None, providers=None, onnx=False, hpa=False):
        ...
        if self.onnx:
            ...
            from advanced_rvc_inference.engine.models.predictors.RMVPE.e2e import E2E
