...
class PESTO:
    def __init__(self, model_path, step_size=10, reduction="alwa", num_chunks=1, sample_rate=16000, device=None, providers=None, onnx=False):
        ...
        if self.onnx:
            ...
            from advanced_rvc_inference.engine.models.predictors.PESTO.model import PPESTO, Resnet1d
            from advanced_rvc_inference.engine.models.predictors.PESTO.preprocessor import Preprocessor
