...
VOCODER_REGISTRY: Dict[str, Dict[str, Any]] = {
    "HiFi-GAN": {
        "module": "advanced_rvc_inference.engine.models.generators.hifigan",
    ...
    "Default": {
        "module": "advanced_rvc_inference.engine.models.generators.nsf_hifigan",
    ...
    "MRF-HiFi-GAN": {
        "module": "advanced_rvc_inference.engine.models.generators.mrf_hifigan",
    ...
    "RefineGAN": {
        "module": "advanced_rvc_inference.engine.models.generators.refinegan",
    ...
    "BigVGAN": {
        "module": "advanced_rvc_inference.engine.models.generators.bigvgan",
    ...
    "RingFormer": {
        "module": "advanced_rvc_inference.engine.models.algorithms.generators",
    ...
    "Vocos": {
        "module": "advanced_rvc_inference.engine.models.generators.vocos",
    ...
    "HiFi-GAN-v3": {
        "module": "advanced_rvc_inference.engine.models.generators.hifigan_v3",
    ...
    "JVSF-HiFi-GAN": {
        "module": "advanced_rvc_inference.engine.models.generators.jvsf_hifigan",
    ...
    "WaveGlow": {
        "module": "advanced_rvc_inference.engine.models.generators.waveglow",
    ...
    "NSF-APNet": {
        "module": "advanced_rvc_inference.engine.models.generators.nsf_apnet",
    ...
    "FullBand-MRF": {
        "module": "advanced_rvc_inference.engine.models.generators.fullband_mrf",
