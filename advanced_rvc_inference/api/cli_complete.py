#!/usr/bin/env python3
"""
Advanced RVC Inference CLI (legacy / direct invocation)
=======================================================
Provides subcommand-based direct invocation for training,
separation, dataset creation, etc.

Usage:
    python -m advanced_rvc_inference.api.cli_complete --help
"""
...
argv_is_allows = [
    ...
    "--extract", "--preprocess", "--separator_music", "--train",
...
if argv in _CMD_MAP:
    ...
    mod = import_module(_CMD_MAP[argv])
    main = getattr(mod, "main", None)
    if main:
        main()
    else:
        print(f"Module {_CMD_MAP[argv]} has no main() function")
        sys.exit(1)
    ...
    print("""Parameters for --convert:
        ...
        2. F0 configuration:
            - `--f0_method` (default: `rmvpe`): F0 prediction method.
    ...
    print("""Parameters for --create_dataset:
        ...
        3. Vocal separation & effects:
            ...
            - `--model_name` (default: `MDXNET_Main`): Separation model.
            - `--reverb_model` (default: `MDX-Reverb`): Separation model.
            - `--denoise_model` (default: `Normal`): Separation model.
    ...
    print("""Parameters for --separate_music:
        ...
        2. Model configuration:
            - `--model_name` (default: `MDXNET_Main`): Separation model.
            - `--karaoke_model` (default: `MDX-Version-1`): Karaoke model.
            - `--reverb_model` (default: `MDX-Reverb`): Separation model.
            - `--denoise_model` (default: `Normal`): Separation model.
    ...
    print("""Parameters for --train:
        ...
        5. Advanced training configuration:
            ...
            - `--vocoder` (default: `HiFi-GAN`): Vocoder to use.
        ...
        8. Optimization:
            - `--checkpointing` (default: `False`): Enable/disable checkpointing to save RAM.
            - `--deterministic` (default: `False`): When enabled, uses highly deterministic algorithms.
