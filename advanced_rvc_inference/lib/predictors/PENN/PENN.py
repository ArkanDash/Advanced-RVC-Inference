...
from advanced_rvc_inference.lib.predictors.PENN.core import bins_to_cents, cents_to_frequency
from advanced_rvc_inference.lib.predictors.PENN.core import PITCH_BINS, CENTS_PER_BIN, OCTAVE, frequency_to_bins, seconds_to_samples, entropy, interpolate
...
class PENN:
    def __init__(self, model_path, hop_length = 80, batch_size = None, f0_min = 31, f0_max = 1984, sample_rate = 8000, interp_unvoiced_at = None, device = None, providers = None, onnx = False):
        ...
        if self.onnx:
            ...
            from advanced_rvc_inference.lib.predictors.PENN.fcn import FCN
