...
from advanced_rvc_inference.uvr.architectures.algorithm.residuals import ResidualCouplingBlock
from advanced_rvc_inference.uvr.architectures.algorithm.encoders import TextEncoder, PosteriorEncoder
from advanced_rvc_inference.uvr.architectures.algorithm.commons import slice_segments, rand_slice_segments
    ...
    def __init__(self, spec_channels, segment_size, inter_channels, hidden_channels, filter_channels, n_heads, n_layers, kernel_size, p_dropout, resblock, resblock_kernel_sizes, resblock_dilation_sizes, upsample_rates, upsample_initial_channel, upsample_kernel_sizes, spk_embed_dim, gin_channels, sr, use_f0, text_enc_hidden_dim=768, vocoder="Default", checkpointing=False, onnx=False, energy=False, **kwargs):
        ...
        if use_f0:
            if vocoder == "RefineGAN": 
                from advanced_rvc_inference.uvr.architectures.generators.refinegan import RefineGANGenerator
                ...
                from advanced_rvc_inference.uvr.architectures.generators.mrf_hifigan import HiFiGANMRFGenerator
                ...
                from advanced_rvc_inference.uvr.architectures.algorithm.generators import RingFormerGenerator
                ...
                from advanced_rvc_inference.uvr.architectures.algorithm.generators import PCPH_GAN_Generator
                ...
                from advanced_rvc_inference.uvr.architectures.generators.nsf_hifigan import HiFiGANNRFGenerator
            ...
            from advanced_rvc_inference.uvr.architectures.generators.hifigan import HiFiGANGenerator
