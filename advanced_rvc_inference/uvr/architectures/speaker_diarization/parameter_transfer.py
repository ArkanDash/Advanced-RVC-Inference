...
from advanced_rvc_inference.uvr.architectures.speaker_diarization.speechbrain import fetch, run_on_main
from advanced_rvc_inference.uvr.architectures.speaker_diarization.features import DEFAULT_TRANSFER_HOOKS, DEFAULT_LOAD_HOOKS
