...
def convert_audio(
    ...
    if use_audio:
        ...
        from advanced_rvc_inference.uvr.architectures.utils import pydub_load
...
def whisper_process(
    ...
    from advanced_rvc_inference.uvr.architectures.speaker_diarization.whisper import load_model
...
def convert_with_whisper(
    ...
    try:
        ...
        from advanced_rvc_inference.uvr.architectures.utils import clear_gpu_cache, pydub_load
        from advanced_rvc_inference.uvr.architectures.speaker_diarization.audio import Audio
        from advanced_rvc_inference.uvr.architectures.speaker_diarization.segment import Segment
        from advanced_rvc_inference.uvr.architectures.speaker_diarization.embedding import SpeechBrainPretrainedSpeakerEmbedding
