...
class FeatureInput:
    def __init__(self, f0_method="rmvpe", device="cpu"):
        ...
        self.f0_min = 50.0
        self.device = device
        self.f0_gen = Generator(self.sample_rate, 160, self.f0_min, self.f0_max, 0.5, False, self.device)
    ...
    def process_file(self, file_info):
        ...
        try:
            ...
            np.save(opt_path_full, pitchf, allow_pickle=False)
            np.save(opt_path_coarse, pitch, allow_pickle=False)
