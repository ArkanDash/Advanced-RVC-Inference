...
from .model import DJCMM
from .spec import Spectrogram
from .utils import WINDOW_LENGTH, SAMPLE_RATE, N_CLASS

class DJCM:
    def __init__(self, model_path, device = "cpu", is_half = False, batch_size = 1, segment_len = 5.12, kernel_size = 3):
