...
def load_embedding(embedder_model, custom_embedder=None):
    embedder_root = os.path.join("advanced_rvc_inference", "rvc", "models", "embedders")
    embedding_list = {
        ...
        "portuguese_hubert_base": os.path.join(embedder_root, "portuguese_hubert_base"),
    }
    ...
    online_embedders = {
        ...
        "portuguese_hubert_base": "https://huggingface.co/AnhP/Vietnamese-RVC-Project/resolve/main/embedders/transformers/portuguese_hubert_base/pytorch_model.bin"
    }
    ...
    config_files = {
        ...
        "portuguese_hubert_base": "https://huggingface.co/AnhP/Vietnamese-RVC-Project/resolve/main/embedders/transformers/portuguese_hubert_base/config.json"
    }
