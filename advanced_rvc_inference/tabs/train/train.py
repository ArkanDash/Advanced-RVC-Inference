...
pretraineds_custom_path = os.path.join(
    "advanced_rvc_inference", "rvc", "models", "pretraineds", "custom"
)
...
# Dataset Creator
datasets_path = os.path.join("advanced_rvc_inference", "assets", "datasets")
...
# Model Names
models_path = os.path.join("advanced_rvc_inference", "logs")
...
def save_drop_dataset_audio(dropbox, dataset_name):
    if not dataset_name:
        ...
        if file_extension not in sup_audioext:
            ...
            dataset_path = os.path.join("advanced_rvc_inference", "assets", "datasets", dataset_name)
