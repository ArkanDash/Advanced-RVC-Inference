...
tts_voices_path = os.path.join("advanced_rvc_inference", "rvc", "lib", "tools", "tts_voices.json")
    ...
    with gr.Accordion(i18n("Advanced Settings"), open=False):
        with gr.Column():
            output_tts_path = gr.Textbox(
                ...
                value=os.path.join("advanced_rvc_inference", "assets", "audios", "tts_output.wav"),
                interactive=True,
            )
            output_rvc_path = gr.Textbox(
                label=i18n("Output Path for RVC Audio"),
                placeholder=i18n("Enter output path"),
                value=os.path.join("advanced_rvc_inference", "assets", "audios", "tts_rvc_output.wav"),
                interactive=True,
            )
