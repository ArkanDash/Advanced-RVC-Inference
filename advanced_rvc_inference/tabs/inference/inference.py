...
custom_embedder_root = os.path.join(
    "advanced_rvc_inference", "rvc", "models", "embedders", "embedders_custom"
)

PRESETS_DIR = os.path.join("advanced_rvc_inference", "assets", "presets")
FORMANTSHIFT_DIR = os.path.join("advanced_rvc_inference", "assets", "formant_shift")
            ...
            with gr.Column():
                ...
                output_path = gr.Textbox(
                    ...
                    value=(
                        ...
                        if audio_paths
                        else os.path.join("advanced_rvc_inference", "assets", "audios", "output.wav")
                    ),
                    interactive=True,
                )
        ...
        with gr.Row():
            with gr.Column():
                input_folder_batch = gr.Textbox(
                    ...
                    value=os.path.join("advanced_rvc_inference", "assets", "audios"),
                    interactive=True,
                )
