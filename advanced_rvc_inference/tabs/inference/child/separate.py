    ...
    with gr.Row():
        ...
        with gr.Column():
            ...
            with gr.Accordion(translations["input_output"], open=False):
                ...
                output_dirs = gr.Textbox(label=translations["output_folder"], value="advanced_rvc_inference/assets/audios/uvr", placeholder="audios", info=translations["output_folder_info"], interactive=True)
